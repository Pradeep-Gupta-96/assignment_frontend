export const allQuestionsA1 = [
    ...
    },
    {
        ...
        options: [
            ...
            "C. Two countries will deport criminals on reciprocal basis to each other",
            "D. None of the above",
        ],
    },
    {
    ...
    },
    {
        ...
        options: [
            "A. An agreement containing a clause regarding services likely to cause an appreciable adverse effect on competition in India",
            "B. An agreement containing a clause that there will be a discontinuation in the supply of goods if the dealer is also dealing in products of supplier’s competition.",
