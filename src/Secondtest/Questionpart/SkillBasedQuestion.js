 ...
 export const Capital_Market_Securities=[
    {
        ...
        options: [
            ...
            "C. Security and Exchange Board of India Act, 1992",
            "D. (ii) and (iii)",
            "E. All of the above",
        ],
    },
 ...
 export const Mediation_and_Conciliation=[
    {
        ...
        options: [
            ...
            "B. To promote communication and understanding between the parties.",
            "C. To assist the parties in identifying and exploring their interests.",
            "D. To impose a settlement on the parties.",
        ],
    },
    {
    ...
    },
    {
        ...
        options: [
            ...
            "B. It is more flexible and allows the parties to control the outcome.",
            "C. It is more likely to result in a mutually agreeable solution.",
            "D. All of the above.",
        ],
    },
 ]
 export const Merger_Acquisition=[
    {
        ...
        options: [
            ...
            "B. The acquisition of one company by another company, where the acquired company retains its separate legal and operational existence.",
            "C. The transfer of all or a substantial part of the assets and liabilities of one company to another company.",
            "D. All of the above.",
        ],
    },
    {
        ...
        options: [
            ...
            "B. Increasing market share of a dominant player.",
            "C. Creating a monopoly or duopoly.",
            "D. All of the above.",
        ],
    },
    {
        ...
        options: [
            ...
            "B. Ensure fair and transparent disclosure of information to shareholders.",
 ...
 export const Sports_Law=[
    {
        ...
        options: [
            ...
            "B. Protect the rights of athletes and sportsperson.",
            "C. Regulate the activities of sports federations and associations.",
            "D. All of the above.",
        ],
    },
    {
        ...
        options: [
            ...
            "B. Educating athletes about doping prevention. ",
            "C. Imposing sanctions on athletes who violate anti-doping rules.",
            "D. All of the above.",
        ],
    },
    {
        ...
        options: [
            ...
            "B. Determine the telecast rights for sporting events.",
            "C. Set the rates for broadcasting rights.",
            "D. All of the above.",
        ],
    },
 ]
 export const Intellectual_Property_Rights=[
    {
        ...
        options: [
            ...
            "B. Inventions, designs, trademarks, and trade secrets.",
            "C. Plant varieties and geographical indications.",
            "D. All of the above.",
        ],
    },
    {
        ...
        options: [
            ...
            "B. Distinctive marks used in trade to identify goods or services of a particular source.",
            "C. Geographical indications, which are signs used to identify goods as originating from a particular geographical area.",
            "D. Undisclosed information that has commercial value.",
        ],
    },
    {
 ...
 export const Labour_Laws=[
    {
        ...
        options: [
            ...
            "B. Provides for the social security and welfare of workers.",
            "C. Protects workers from exploitation and abuse.",
            "D. All of the above.",
        ],
    },
    {
        ...
        options: [
            ...
            "B. Ensures that workers receive a fair and living wage.",
            "C. Protects workers from exploitation and poverty.",
            "D. All of the above.",
        ],
    },
    {
        ...
        options: [
            ...
            "B. Establishes a machinery for the conciliation and arbitration of industrial disputes.",
            "C. Protects workers from unfair dismissal and retrenchment.",
            "D. All of the above.",
        ],
    },
 ]
 export const International_Business_Law=[
    {
        ...
        options: [
            ...
            "B. Liaison Office ",
            "C. Project Office",
            "D. Resident Representative Office",
        ],
    },
    {
        ...
        options: [
            ...
            "B. Compliance with the FDI policy of the Government of India",
            "C. Registration with the RBI",
            "D. None of the above",
        ],
    },
    {
        ...
        options: [
            ...
            "B. 100% income tax exemption for the first five years of operation",
            "C. Single window clearance for all approvals",
            "D. Relaxation in labor laws",
        ],
    },
 ]
 export const Startup_in_India_related_legal_Question=[
    {
        ...
        options: [
            ...
            "B. Self-certification of compliance with certain laws and regulations",
            "C. Access to government-funded incubators and accelerators ",
            "D. Exemption from foreign direct investment (FDI) limits",
        ],
    },
    {
        ...
        options: [
            ...
            "B. The startup must have not more than 20 shareholders.",
            "C. The startup must not have been in existence for more than seven years.",
            "D. All of the above.",
        ],
    },
    {
        ...
        options: [
            ...
            "B. Networking opportunities with other startups and investors",
            "C. Visibility to potential customers and partners",
            "D. Exemption from labour laws",
        ],
    },
 ]
 export const Insurance_Law=[
    ...
    },
    {
        ...
        options: [
            ...
            "B. The company must have a board of directors with at least two-thirds of the directors being Indian residents.",
            "C. The company must have an actuary on its board of directors.",
            "D. The company must have a sound financial plan.",
        ],
    },
    {
        ...
        options: [
            ...
            "B. The right to choose their own insurance company and insurance agent.",
            "C. The right to file a complaint with the IRDAI if they are dissatisfied with the services of their insurance company.",
            "D. The right to cancel their insurance policy at any time.",
        ],
    },
 ]
 export const Joint_Venture_Public_private_partnership_and_MSME=[
    {
        ...
        options: [
            ...
            "B. Increased resources and expertise",
            "C. Reduced risk ",
            "D. Loss of control over the business",
        ],
    },
    {
        ...
        options: [
            ...
            "B. Design-build-finance-operate-maintenance (DBFOM)",
            "C. Public-private partnership infrastructure development fund (PPPIDF)",
            "D. Joint venture (JV)",
        ],
    },
    {
        ...
        options: [
            ...
            "C. Credit Guarantee Fund Scheme for Micro and Small Enterprises (CGTMSE)",
            "D. Startup India",
        ],
    },
 ]
    ...
    },
    {
        ...
        question: (<div style={{display: "inline"}}>
            ...
            <div className="four-op">
                <ul className="op-row">
                    <li className="op1">Income slab </li>
                    <li className="op1">Up to ₹3 lakhs </li>
                    <li className="op1">₹3 lakhs to ₹7.5 lakhs </li>
                    <li className="op1">₹7.5 lakhs to ₹10 lakhs </li>
                    <li className="op1">Above ₹10 lakhs</li>
                </ul>
                <ul className="ans-row">
                    <li className="ans1">Income tax rate </li>
                    <li className="ans1">0%</li>
                    <li className="ans1">5%</li>
                    <li className="ans1">20%</li>
                    <li className="ans1">30%</li>
                </ul>
            </div>
        </div>
        ),
 ...
 export const ARBITRATION=[
    {
        ...
        options: [
            ...
            "B. Be binding on government authoritys",
            "C. Be binding on first-party only",
            "D. Be binding on the parties and persons claiming under them respectively",
        ],
    },
    {
 ...
 export const IBC=[
    ...
    },
    {
        ...
        options: [
            ...
            "B. Cessation of business by the corporate debtor",
            "C. Appointment of a receiver or manager for the corporate debtor",
            "D. All of the above",
        ],
    },
    {
 ...
 export const Competitive_and_Anti_Trust=[
    {
        ...
        options: [
            ...
            "B. Actions to restrain trade.",
            "C. Actions to stop nuisance.",
            "D. Actions to limit breach of contract.",
        ],
    },
 ]
 export const AVIATION_LAW=[
    ...
    },
    {
        ...
        options: [
            ...
            "B. To provide adequate training to its pilots and other crew members.",
            "C. To operate its flights in accordance with all applicable laws and regulations.",
            "D. To sell tickets to passengers who are not eligible to fly.",
        ],
    },
    {
        ...
        options: [
            ...
            "B. The right to be compensated for lost or damaged baggage.",
            "C. The right to be provided with meals and drinks on long-haul flights.",
            "D. The right to be seated next to their traveling companion.",
        ],
    },
 ]
 export const Environment=[
    {
        ...
        options: [
            ...
            "B. The power of the Central and State Governments to make rules and regulations to prevent and control water pollution.",
            "C. The prohibition of the discharge of trade effluents into water bodies without prior treatment and consent of the Pollution Control Board.",
            "D. The establishment of a National Green Tribunal to hear and dispose of cases related to environmental protection.",
        ],
    },
    {
        ...
        options: [
            ...
            "B. The area is important for maintaining ecological balance.",
            "C. The area is vulnerable to natural disasters.",
            "D. All of the above.",
        ],
    },
    {
        ...
        options: [
            "A. The right to life",
            "B. The right to clean air and water",
...
Please read the following situation and answer. 
        </div>
        ),
        options: [
            "A. Factually true",
 ...
 export const Public_Policy=[
    {
        ...
        options: [
            ...
            "B. Tim's team knows that the country's main problem is the high public debt. They are trying to determine whether they should implement austerity measures, ask for a research study to determine how to best combat the debt or ask for a loan from the International Monetary Fund.",
            "C. Tim's team is trying to figure out what the main problem of the country is. They are brainstorming and several have mentioned slow economic growth, while others have concluded that it is a bad foreign policy. They have concluded that the problem is slow economic growth caused by a very inefficient public sector.",
    ...
    },
    {
        ...
        options: [
            ...
            "B. OLSR (Ordinary Least Squares Regression)",
            "C. Cost-benefit analysis",
            "D. SWOT (Strength, Weaknesses, Opportunities, Threats)",
        ],
    },
 ]